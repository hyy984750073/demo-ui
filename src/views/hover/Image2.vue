<template>
  <div class="app-container page-image2">
    <aside>
      Dimitra Vasilopoulou
      在基础的图像悬停效果上更进一步，创建了这种动态网格效果。如果你是 Greensock
      的粉丝，这个悬停效果就是你的完美之选。
      <br /><br />
      <a href="https://codepen.io/mimikos/details/yXZxKK" target="_blank"
        >点击在线编辑查看效果</a
      >
    </aside>
  ...
  mounted() {
    ...
    function checkTileNumber() {
      tileHolder.style.width =
        Math.ceil(tileContainer.offsetWidth / tileWidth) * tileWidth + "px";
    ...
    function positionImage() {
      for (var t = 0, l = numTiles; t < l; t++) {
        ...
        var top =
          -nowTile.offsetTop -
          (tileHolder.offsetTop - tileHolder.offsetHeight / 2);
